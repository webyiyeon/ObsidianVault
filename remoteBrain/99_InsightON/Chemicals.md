...
##### 사고관리 
- [x] 중간보고 → 최종보고 로 문구 수정
- [ ] 출력물에 \[최초, 최종, 완료] 인지 구분할 수 있도록 양식 수정 (ex. 안전사고조사보고서(최초))
- [ ] 상해사고보고서 
	- [ ] 다운로드, 열람 불가 (이미지 파일 관련)
	- [ ] 소속부서, 사고등급/유형, 사고원인 및 대책이 빈칸으로 출력 
- [ ] 안전사고조사보고서 우측 상단 결재란 수정 
	- [ ] 안전환경팀장 → SHE팀 (==이름 자동 작성되지 않도록 수정==) 
	- [ ] 작성 → 검토 → 부서장 → 본부장 으로 변경 (현재 매니저 → 매니저 → 팀장 → 공장장)
- [ ] 안전환경팀의견 → SHE팀 의견으로 문구 수정
- [ ] 최초작성임에도 '사고경과'에 이전에 작성했던 내역 남아있음
- [ ] 공정사고 분류 수정: (1) 위험물질 노출 (2) 화재/폭발 (3) 설비고장 (4) U/T 사고 (5) 생산손실 사고
- [ ] 사고조사일시 및 조사참여자 추가 시, 구성원 직급은 HR의 G3, G2 등 정보 가져올 수 있도록 수정
	- [ ] 현재 직급 공란인 경우도 있음 (새로 기입 불가)
	- [ ] 협력사는 직접 작성 가능
- [ ] 사고조사일시 및 조사참여자: 협력사 추가 후 SK 케미컬 구성원 추가 시 성명 누락되는 오류 발생
- [ ] 안전사고조사보고서 출력 시, (6) 조사일시 및 조사참여자가 작성된 것처럼 기입되지 않음 (부서명 누락, 중복 기입)
- [ ] 사업장 사내사고에서 결재가 완료된 사내사고 열람 시, 
	- [ ] 사고조사일시 및 조사참여 정보 모두 누락
	- [ ] 비상조치 내용 및 평가 정보 누락
- [ ] 공정사고에서는 사고원인에 '심리원인' 삭제
- [ ] 사고 등급이 다르게 표시되는 오류 (C급인데 A급으로 표시)
