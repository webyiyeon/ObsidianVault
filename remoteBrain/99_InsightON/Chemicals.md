...
##### 출입자 교육 관련 
- [ ] 협력업체 출입자 교육 신청 시, 담당자에게 메일 알림 발송 
- [ ] 공사주관 부서 검색 시 'SHE'로  SHE팀(울산) 검색 안됨 (공통)
- [ ] 공사 Area의 '기타' ⇒ '기타(직접입력)' 변경
- [ ] 최초 신규등록 시, 제출 / 저장 버튼 2개로 변경
- [ ] 담당자 확인 단계에서 '확인' ⇒ '승인' 으로 문구 변경
- [ ] 타 협력업체 정보 조회 불가하도록 수정 