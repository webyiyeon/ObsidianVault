...
- [ ] LOTO,Blind ,P&ID List 첨부  
	...
	- [x] 일반 작업의 기압 Test
	- [x] 일반 작업의 Blind 설치 해체 작업
	- [ ] 안전 작업의 밀폐 공간  
	- [ ] 안전 작업의 Blind 설치 해체 작업  
	- [x] 취급 화학물질 9개 항목 중 하나 이상

- [ ] 위 조건이 모두 해제되면 위 항목도 자동 해제되어야 한다.

- [x] 일반위험작업에서 **유해위험물질 저장, 취급, 사용 선택**이 되어있는 경우,
...
- [ ] 안전 조치사항 공통에서 취급 화학물질 MSDS 교육 첨부를 선택한 경우 MSDS 파일은 필수로 첨부되어야 한다.
...
- [x] 일반 작업에서 취급 화학물질 선택
	공통 첨부는 LOTO List, Blind List, P&ID가 체크된다.  
	허가부서 필수 첨부는 LOTO List와 P&ID이다.

- [x] 일반 작업에서 취급 화학물질과 탱크로리를 함께 선택
	공통 첨부는 해제된다.  
...
- [x] 안전 작업에서 전기와 밀폐 공간 선택
	공통 첨부는 LOTO List, Blind List, P&ID가 체크된다.  
	신청부서 필수 첨부는 LOTO List와 전기 단선도이다.  
	허가부서 필수 첨부는 LOTO List와 P&ID이다.

- [x] 안전 작업에서 전기와 Blind 설치 해체 작업 선택
	공통 첨부는 LOTO List, Blind List, P&ID가 체크된다.  
	신청부서 필수 첨부는 LOTO List와 전기 단선도이다.  
	허가부서 필수 첨부는 Blind List와 P&ID이다.
