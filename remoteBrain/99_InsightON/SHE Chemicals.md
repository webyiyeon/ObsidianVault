...
- [ ] 여기서 Blind 설치 해체 작업은 일반 작업에서 선택된 경우와 안전 작업에서 선택된 경우를 모두 포함한다.

- [ ] Blind 설치 해체 작업이 선택된 경우에는 다음 두 항목이 필수 첨부이다.
	- [ ] Blind List
	- [ ] P&ID

- [ ] Blind 설치 해체 작업이 선택되지 않은 경우에는 다음 두 항목이 필수 첨부이다.
	- [ ] LOTO List
	- [ ] P&ID

- [ ] 다만 이 허가부서 필수 첨부 기준은 기압 Test, Blind 설치 해체 작업, 밀폐 공간, 취급 화학물질 등으로 인해 첨부 필요 조건이 발생한 경우를 전제로 적용해야 한다.

- [ ] 즉, 탱크로리 단독 선택처럼 애초에 첨부 필요 조건이 없는 경우에는 허가부서에서도 필수 첨부가 발생하지 않는다.
 
- [ ] 필수 첨부를 건너뛸 경우에는 사유를 입력해야 하며, 입력된 사유는 검토의견에 자동 삽입되어야 한다.

### 5. 신청부서 단계 전기 작업 기준

- [ ] 안전 작업에서 전기 동력 차단 작업을 선택한 경우에는 안전 조치사항 전기의 다음 두 항목이 자동 체크되어야 한다.
	- [ ] LOTO List 첨부
	- [ ] 전기 단선도 첨부

- [ ] 위 두 항목은 신청부서 단계에서 필수 첨부이다.

- [ ] 필수 첨부를 건너뛸 경우에는 사유를 입력해야 하며, 입력된 사유는 검토의견에 자동 삽입되어야 한다.

- [ ] 전기 작업은 다른 조건에 의해 해제되지 않는다.

### 6. 전기 작업과 다른 조건의 관계

- [ ] 전기 작업은 항상 최우선으로 적용된다.

- [ ] 따라서 전기 작업이 선택된 경우에는 다른 조건과 관계없이 신청부서 단계에서 LOTO List와 전기 단선도는 반드시 유지되어야 한다.

- [ ] 다만 전기 작업과 함께 밀폐 공간, Blind 설치 해체 작업, 취급 화학물질이 선택될 수 있으므로, 이 경우에는 전기 첨부와 공통 첨부 로직이 함께 적용될 수 있다.

- [ ] 예를 들어 **전기**와 **밀폐 공간**이 함께 선택된 경우에는 **공통 첨부 세 항목**이 자동 체크되고,
      신청부서에서는 **LOTO List와 전기 단선도**가 필수이며, 
      허가부서에서는 Blind 작업이 아니므로 **LOTO List와 P&ID**가 필수이다.

- [ ] **전기**와 **Blind 설치 해체 작업**이 함께 선택된 경우에는 **공통 첨부 세 항목**이 자동 체크되고,
       신청부서에서는 **LOTO List와 전기 단선도**가 필수이며, 
       허가부서에서는 **Blind List와 P&ID**가 필수이다.

- [ ] 전기와 취급 화학물질이 함께 선택된 경우에도 전기 첨부는 그대로 유지되며, 공통 첨부는 취급 화학물질에 의해 체크된다.

- [ ] 전기와 탱크로리는 함께 선택될 수 없다. 전기는 안전 작업이고 탱크로리는 일반 작업이기 때문이다.
...
- [ ] Blind 설치/해체 작업 항목이 선택되어 있다면 Blind list만 첨부 필수 (허가부서 단계)
- [ ] Blind 설치/해체 작업 항목이 선택되어 있지 않다면 LOTO List, P&ID 첨부 필수 (허가부서 단계)
- [ ] 취급화학물질 선택 or 기타항목 작성 시 MSDS 첨부할 수 있는 항목 생성 
- [ ] 협력사/신청부서/허가부서 각 결재 단계에서 팝업창 떠야 함
- [ ] 협력사 / 신청부서 단계에서는 팝업창이 띄되 검토의견 삽입안해도 확인 누르면 넘어감. 
- [ ] 허가부서 단계까지 왔을 때 이전에 MSDS첨부파일이 없다면 첨부 없이 결재가 진행되면 안됨.
- [ ] 안전점검 > 전기(동력)차단 선택 시 LOTO LIST, 전기단선도 첨부 필수(신청부서 단계)
