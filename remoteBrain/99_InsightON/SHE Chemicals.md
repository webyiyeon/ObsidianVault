...
- [ ] 취급 화학물질 9개 중 하나라도 선택되면 공통 첨부 항목은 자동 체크된다.

- [ ] 다만 취급 화학물질과 일반 작업의 탱크로리 입출하 작업이 동시에 선택된 경우에는 공통 첨부 항목이 자동 해제되어야 한다.

- [ ] 즉, 취급 화학물질은 공통 첨부를 발생시키는 조건이고, 탱크로리는 단독으로는 아무 첨부도 발생시키지 않으며, 취급 화학물질과 함께 있을 때만 공통 첨부를 해제하는 조건이다.

- [ ] 따라서 일반 작업에서 탱크로리만 선택된 경우에는 공통 첨부도 없고, 별도의 필수 첨부도 없다.
