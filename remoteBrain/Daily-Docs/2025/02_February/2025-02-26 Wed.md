...
- [ ] 00:00 - 00:00 #work💼 시스템 안전 오류 수정 작업
	- [ ] #work💼 PSM > 설비점검/유지보수 > 공기호흡기/용기 > 용기검사 : 타이틀 수정
	- [ ] #work💼 PSM > 설비점검/유지보수 > 점검일지 : 대상설비 추가 팝업 검색 오류 수정
	- [ ] #work💼 PSM > 설비점검/유지보수 > 점검일지 : 저장 안됨
	- [ ] #work💼 PSM > 가동전 안전점검 > 가동전안전점거
	- [ ] 
- [ ] 10:30 - 11:00 #todo Ipad 환불 관련 확인
